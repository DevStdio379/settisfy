      ...
      <ScrollView
        ...
        <View style={{ paddingTop: 20, justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ width: '90%' }}>
            ...
            />
            <Text style={{ fontSize: 16, color: COLORS.title, fontWeight: 'bold', marginTop: 15, marginBottom: 5 }}>Cooldown Period (for customer warranty)</Text>
            <Input
              onFocus={() => setIsFocused('cooldownPeriodHours')}
              onBlur={() => setIsFocused(null)}
              isFocused={isFocused === 'cooldownPeriodHours'}
              value={cooldownPeriodHours.toString()}
              onChangeText={setCooldownPeriodHours}
              backround={COLORS.card}
              style={{
                fontSize: 12,
                borderRadius: 12,
              ...
              keyboardType={'numeric'}
              inputicon
              placeholder='e.g. 3 hours cooldown after job completion'
            />
